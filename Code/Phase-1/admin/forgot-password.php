...
<head>
	...
	<title>BTS | Manager passwword recovery</title>
...
<body>
			...
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="../index.html" style="color:#faf0e6; background-color: black; font-family:verdana;">
			  		The Bug Tracking System | Manager/Employee
			  	</a>
	...
	<div style="background-size: cover; background-image: url('images/rob.jpg'); Padding: 110px; ">
		<div class="container">
			<div class="row">
...
<div class="control-group">
								...
								<div class="controls row-fluid">
									<select class="span12" name="usertype" required="true">
										...
										<option value="subadmin">Developer</option>
									</select>
								</div>
							</div>
	...
	<div class="footer">
		<div class="container">
			...
			<b class="copyright">&copy; BTS </b> All rights reserved.
		</div>
	</div>
