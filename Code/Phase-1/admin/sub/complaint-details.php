...
if($result==0){
?>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Assignee</button>
<?php }} ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<label class="control-label" for="forwardto"><strong>Assignee</strong></label>
