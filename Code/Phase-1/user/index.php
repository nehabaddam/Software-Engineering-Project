...
<html lang="en">
  <head>
    ...
    <title>BTS | Customer Login</title>
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page" >
	  	<div class="container" >
	  		<h1 align="center" style="color:#c46210;"><b><a href="../index.html" style="color: #faf0e6;">The Bug Tracking System</a></b></h1>
	<hr />
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading" style="color: white ; background-color: black; border: 1px solid #faf0e6;" >sign in</h2>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap" >
		            ...
		            <button class="btn btn-theme btn-block" style="color:white; background-color: #8c8c8c" name="submit" type="submit"><i class="fa fa-lock"></i> Sign In</button>
		            <hr>
		           </form>
