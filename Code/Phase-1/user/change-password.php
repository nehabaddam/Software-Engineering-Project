...
{
$errormsg="Old Password does not match New Password!!";
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>BTS | Customer Change Password</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h2 style="color:#ff4500; background-color:black;"><i class="fa fa-angle-right"></i> Change Password</h2>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Customer Change Password</h4>
...
<button type="submit" name="submit" class="btn btn-primary" style="color:white; background-color:grey;">Submit</button>
</div>
</div>
