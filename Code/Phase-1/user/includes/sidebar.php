<aside>
          <div id="sidebar"  class="nav-collapse " style = "background-color:#292929; ">
              <!-- sidebar menu start-->
...
<?php endif;?>
                  ...
                  <h5 class="centered" style = "color:white;"><?php echo htmlentities($row['fullName']);?></h5>
                  <?php } ?>
				  ...
				  <span style = "color:white;"><b>Account Setting</b></span>
                  ...
                  <li class="sub-menu">
                      <a href="register-complaint.php" >
                          ...
                          <span style = "color:white;"><b>Create Bug</b></span>
                      </a>
                    </li>
                  </li>
                  <li class="sub-menu">
                      <a href="complaint-history.php" >
                          ...
                          <span style = "color:white;"><b>Bug History</b></span>
                      </a>
