...
$complainno=$cmpn;
echo '<script> alert("Your Bug has been successfully filled and your Bug no is  "+"'.$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>BTS | Customer Register Bug</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h2  style="background-color:black;color:#ff4500;" ><i class="fa fa-angle-right"></i> Register Bug</h2>
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Bug</option>
                  <option value="General Query">Information</option>
                </select> 
</div>
...
<?php $sql=mysqli_query($con,"select priorityType from priority ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['priorityType']);?>"><?php echo htmlentities($rw['priorityType']);?></option>
<?php
}
?>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Bug Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Bug Related Doc(if any) </label>
<div class="col-sm-6">
