...
<div class="navbar navbar-fixed-top" >
		<div class="navbar-inner" style="background-color: black; ">
			<div class="container" >
			  	...
			  	<a class="brand" style="color:#faf0e6; background-color: black; font-family:verdana;"> 
			  	 	The Bug Tracking System | User Profile
			  	</a>
...
<label class="control-label" for="basicinput"><strong>Creation Date:</strong></label>
...
<div class="control-group">
<label class="control-label" for="basicinput"><strong>Employee Name</strong></label>
<div class="controls">
