 ...
 <!-- Wrapper for Slides -->
        <div class="carousel-inner">
            ...
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('images/rob.jpg');"></div>
...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h2 style="padding-left: 2%; padding-top:3%; color:#ff4500">Dashboard</h2>
							</div>
...
<table border="2" align="center" width="80%" style="">
	<tr>
		...
		<th style="color:#ffd300;text-align:center; font-size:16px;">Not Assigned</th>
		<th style="color:red;text-align:center;font-size:16px">To Do</th>
		<th style="color:orange;text-align:center;font-size:16px">In Progress</th>
		<th style="color:#228b22;text-align:center;font-size:16px">Closed</th>
	</tr>
...
<h3 style="padding-left: 2%; padding-top:3%; color:#ff4500">Employee Bug Report </h3>
<hr />
<table border="2" align="center" width="80%" style="">
	<tr>
		<th style="color:#a0522d;text-align:center; font-size:16px;">Employee Name /Dept</th>
		<th style="color:#000;text-align:center; font-size:16px;">Total</th>
		<th style="color:red;text-align:center; font-size:16px;">To Do</th>
		<th style="color:orange;text-align:center;font-size:16px">In Progress</th>
		<th style="color:#228b22;text-align:center;font-size:16px">Closed</th>
...
<tr>
	<th style="color:#0000cd;text-align:center; font-size:16px;">Grand Total</th>
