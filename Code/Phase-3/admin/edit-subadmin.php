...
<head>
	...
	<title>Admin| Update/Edit Developer</title>
...
<?php include('include/header.php');?>
	...
	<div class="wrapper" style="background-size: cover; background-image: url('images/rob.jpg'); Padding: 130px; ">
		<div class="container">
			<div class="row">
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Update/Edit Employee Details</h3>
							</div>
...
<label class="control-label" for="basicinput">Creation Date</label>
<div class="controls">
...
<div class="controls">
<input type="text" placeholder="Enter Employee Username"  name="sadminusername" id="sadminusername" class="span8 tip"   value="<?php echo htmlentities($row['UserName']);?>" readonly>
...
<div class="controls">
<input type="text" placeholder="Enter Employee Name"  name="subadmin" class="span8 tip" value="<?php echo htmlentities($row['SubAdminName']);?>" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Employee Department</label>
<div class="controls">
<input type="text" placeholder="Enter Employee Department" value="<?php echo htmlentities($row['Department']);?>"  name="subadmindept" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="email" placeholder="Enter Employee Email id" value="<?php echo htmlentities($row['EmailId']);?>"  name="emailid" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text" placeholder="Enter Employee Contact No." pattern="[0-9]{10}" title="10 numeric characters only"  name="contactno" class="span8 tip" required value="<?php echo htmlentities($row['ContactNumber']);?>">
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Employee Account Status</label>
<div class="controls">
