...
$_SESSION['tdate']=$tdate;
	...
	<h2 align="center" style="color:blue;">Employee Report from <?php echo $new_Date = date("d-m-Y", strtotime($fdate));?> to <?php echo $new_Date = date("d-m-Y", strtotime($tdate));?></h2>
</div>
<div class="module-body table">
<table border="2" align="center" width="80%" style="">
	<tr>
		<th style="color:#000;text-align:center; font-size:16px;">Employee Name /Dept</th>
