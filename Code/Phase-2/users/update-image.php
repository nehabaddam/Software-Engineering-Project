...
if($query)
{
$successmsg="Profile picture successfully updated!!";
}
else
{
$errormsg="Profile picture not updated !!";
}
}
}
?>
...
<html lang="en">
  <head>
    ...
    <title>BTS | User Change Password</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h2 style="background-color:black; color:#ff4500;" ><i class="fa fa-angle-right" ></i> Update  Profile Photo</h3>
...
<button type="submit" name="submit" class="btn btn-primary" style="colorwhite; background-color:grey;">Submit</button>
</div>
</div>
